...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-dark absolute top-0 left-0 max-w-screen w-full z-50">
      <div className="w-full flex items-center justify-center my-2">
        <Banner_720 />
      </div>
      <div style={{direction: "ltr"}} className="flex items-center justify-center h-full">
        <div className="bg-whisqate p-8 rounded-lg shadow-lg max-w-md w-full">
