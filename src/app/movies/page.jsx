    ...
    <div className="min-h-screen bg-dark text-white absolute top-0 left-0 z-50  w-full h-full max-w-screen ">
      ...
      <header className="bg-black shadow-lg">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-4xl font-bold">The Movie Vault</h1>
          <nav>
      ...
      <section id="home" className="relative bg-cover bg-center h-screen bg-black bg-opacity-50"
        ...
        <div className="container mx-auto flex flex-col items-center justify-center h-full text-center space-y-6">
          <h2 className="text-6xl font-bold text-yellow-400">Welcome to The Movie Vault</h2>
          <p className="text-xl max-w-2xl">Explore a world of cinematic treasures, from timeless classics to modern blockbusters. Dive deep into the magic of films.</p>
          <a href="https://affordspoonsgray.com/fi4jipsn2?key=82850efc8000cbd9c39de31c1afcdba5" className="bg-yellow-400 text-black px-8 py-4 rounded-full shadow-lg hover:bg-yellow-500 transition">
            Explore Movies
          </a>
        </div>
      </section>
      ...
      <section id="about" className="py-16 bg-gray-800">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-yellow-400 mb-6">About Us</h2>
      ...
      {/* Movies Section */}
      <section id="movies" className="py-16 bg-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-yellow-400 mb-12">Popular Movies</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Movie Card 1 */}
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
              <Image src="/movie1.jpg" width={600} height={400} alt="Movie 1" />
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">Movie Title 1</h3>
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">Movie Title 2</h3>
                <p className="text-gray-400 mb-4">Short description of the movie and its highlights.</p>
                <a href="https://affordspoonsgray.com/fi4jipsn2?key=82850efc8000cbd9c39de31c1afcdba5" className="text-yellow-400 hover:text-yellow-500">Watch Now</a>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2">Movie Title 3</h3>
                <p className="text-gray-400 mb-4">Short description of the movie and its highlights.</p>
                <a href="https://affordspoonsgray.com/fi4jipsn2?key=82850efc8000cbd9c39de31c1afcdba5" className="text-yellow-400 hover:text-yellow-500">Watch Now</a>
              </div>
            </div>
      ...
      <section id="contact" className="py-16 bg-gray-800">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-yellow-400 mb-6">Get in Touch</h2>
          <p className="text-center text-lg max-w-2xl mx-auto mb-12">Have questions or suggestions? Reach out to us and let&#39;s talk movies!</p>
